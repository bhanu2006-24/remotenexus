    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
         ...
         <div className="prose prose-invert prose-lg text-slate-300 mb-24">
           ...
           <p>
             We use advanced AI (Powered by Google's Gemini models) to automate the boring stuff. Our "Nexus Assistant" helps you understand job requirements instantly and drafts tailored applications in seconds, so you can focus on the interview.
           </p>
                ...
                <div className="relative flex-shrink-0">
                   <div className="w-32 h-32 md:w-40 md:h-40 rounded-full p-1 bg-gradient-to-br from-primary to-secondary shadow-2xl">
                      <div className="w-full h-full rounded-full bg-slate-900 flex items-center justify-center overflow-hidden">
                        {/* Using UI Avatar as placeholder, real image would go here */}
                        <span className="font-display font-bold text-4xl text-white">BS</span>
                      </div>
                   </div>
